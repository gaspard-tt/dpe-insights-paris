...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "hero.desc": "On vous aide à estimer votre classe DPE, identifier les points faibles de votre habitat et découvrir les rénovations les plus efficaces — en 5 minutes chrono.",
  ...
  en: {
    ...
    "hero.desc": "We'll help you estimate your EPC class, spot your home's weak points, and discover the most effective renovations to cut your bills — in just 5 minutes.",
    ...
    "envelope.orientation.help": "South-facing orientation allows benefiting from solar gains in winter.",
