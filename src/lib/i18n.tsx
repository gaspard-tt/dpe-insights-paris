...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "hero.desc": "On vous aide à estimer votre classe DPE, identifier les points faibles de votre habitat et découvrir les rénovations les plus efficaces — en 5 minutes chrono ⏱️",
    ...
    "why.bills.desc": "Un logement classe G consomme jusqu'à 6 fois plus qu'un classe A. Comprendre votre DPE, c'est identifier où partent vos euros.",
    "why.regulation.title": "⚖️ Anticiper la réglementation",
    ...
    "why.value.desc": "Un bon DPE augmente la valeur de votre logement. L'écart de prix entre une classe D et B peut atteindre 10 à 15%.",
    "tool.title": "🛠️ Ce que cet outil vous apporte",
    ...
    // Questionnaire
    "wizard.step": "Étape",
    "wizard.prev": "⬅️ Précédent",
    "wizard.next": "Suivant ➡️",
    ...
    "general.surface.help": "La surface permet de rapporter la consommation au mètre carré, base du DPE. Saisissez directement la superficie.",
    ...
    "envelope.floor": "🏗️ Isolation du plancher",
    ...
    "envelope.insulation.idk.desc": "Pas de souci — on utilisera une valeur moyenne pour estimer.",
    ...
    "envelope.window.single": "1️⃣ Simple vitrage",
    "envelope.window.single.desc": "Très peu isolant",
    "envelope.window.double": "2️⃣ Double vitrage",
    "envelope.window.double.desc": "Standard actuel",
    "envelope.window.triple": "3️⃣ Triple vitrage",
    ...
    "envelope.orientation.help": "L'orientation sud permet de bénéficier des apports solaires en hiver. ☀️",
    "envelope.orientation.desc": "Orientation principale du logement",
    "envelope.orientation.idk": "🤷 Je ne sais pas",
    "envelope.orientation.idk.desc": "On utilisera une valeur moyenne",
    ...
    "heating.fuel_boiler": "🛢️ Chaudière fioul",
    "heating.heat_pump": "♻️ Pompe à chaleur",
    ...
    "heating.distribution": "🌡️ Système de distribution",
    ...
    "ventilation.vmc_double": "♻️ VMC double flux",
    ...
    "ventilation.leakage": "🌬️ Fuites d'air perçues",
    ...
    "occupancy.heating_habits": "🌡️ Habitudes de chauffage",
    "occupancy.heating_habits.help": "Chaque degré en plus augmente la consommation d'environ 7%.",
    "occupancy.low": "🧊 Économe — ~18°C, pièces fermées",
    "occupancy.average": "👍 Confortable — 19-20°C, confort standard",
    "occupancy.high": "🔥 Généreux — 21°C+, toutes pièces chauffées",
    ...
    "results.weaknesses": "⚠️ Points faibles identifiés",
    "results.weaknesses.empty": "🎉 Bravo ! Votre logement est déjà bien optimisé. Aucun point faible majeur n'a été identifié.",
    ...
    "results.recommendations": "🔧 Petits gestes, grand impact",
    ...
    "results.edu.2.desc": "La rénovation la plus efficace est celle qui s'attaque au plus gros point faible. Changer de chauffage sans isoler revient à chauffer l'extérieur. Inversement, une bonne isolation réduit les besoins et permet un chauffage plus petit et moins coûteux.",
  ...
  en: {
    ...
    "hero.desc": "We'll help you estimate your EPC class, spot your home's weak points, and discover the most effective renovations to cut your bills — in just 5 minutes ⏱️",
    ...
    "why.regulation.title": "⚖️ Stay ahead of regulations",
    ...
    "tool.title": "🛠️ What this tool offers",
    "tool.desc": "More than just a score: a complete diagnostic with personalised recommendations.",
    ...
    "general.surface.help": "The surface area is used to calculate consumption per square metre, the basis of EPC. Just type it in directly.",
    ...
    "envelope.floor": "🏗️ Floor insulation",
    ...
    "envelope.orientation.help": "South-facing orientation allows benefiting from solar gains in winter. ☀️",
    "envelope.orientation.desc": "Main orientation of the home",
    "envelope.orientation.idk": "🤷 I don't know",
    "envelope.orientation.idk.desc": "We'll use an average value",
    ...
    "heating.fuel_boiler": "🛢️ Oil boiler",
    "heating.heat_pump": "♻️ Heat pump",
    ...
    "heating.distribution": "🌡️ Distribution system",
    ...
    "energy.help": "The type of energy strongly influences the EPC, due to the primary energy conversion factor.",
    "energy.electricity": "⚡ Electricity",
    "energy.electricity.desc": "Most common energy, penalised in EPC calculation (factor 2.3).",
    "energy.gas": "🔵 Natural gas",
    "energy.gas.desc": "Less penalising than electricity for heating.",
    "energy.fuel": "🛢️ Fuel oil",
    "energy.fuel.desc": "Fossil energy being phased out, very unfavourable for EPC.",
    "energy.renewable": "🌿 Renewable energies",
    "energy.renewable.desc": "Wood, solar, geothermal… very favourable for EPC.",
    ...
    "ventilation.vmc_double": "♻️ Dual-flow mechanical ventilation",
    ...
    "ventilation.leakage": "🌬️ Perceived air leaks",
    ...
    "occupancy.6plus": "6 or more people",
    "occupancy.idk": "🤷 I don't know",
    "occupancy.idk.desc": "We'll use an average estimate",
    "occupancy.heating_habits": "🌡️ Heating habits",
    "occupancy.heating_habits.help": "Each additional degree increases consumption by about 7%.",
    "occupancy.low": "🧊 Economical — ~18°C, rooms closed off",
    "occupancy.average": "👍 Comfortable — 19-20°C, standard comfort",
    "occupancy.high": "🔥 Generous — 21°C+, all rooms heated",
    ...
    "results.weaknesses": "⚠️ Identified weak points",
    "results.weaknesses.empty": "🎉 Well done! Your home is already well optimised. No major weak points identified.",
    ...
    "results.recommendations": "🔧 Small changes, big impact",
    ...
    "results.edu.1.title": "💡 EPC is an indicator, not a fate",
    ...
    "results.edu.3.desc": "Loft insulation or air leak treatment are often the cheapest but most effective works. Prioritise cost-effectiveness over the most visible works.",
